          ...
          <div class="row"> 
            <div class="col-md-12">
              ...
              <ul class="list-inline text-white">
                <li>Home /</li>
                <li><span class="text-gray">Login Form</span></li>
              </ul>
            </div>
          </div>
        </div>
...
<form  action="login-check.php" method="POST">
	<h1>Login Form</h1>
        <div class="col-md-12">
            <?php if(!empty($_GET['message'])){
               if($_GET['message']=='invalid'){
                           ?>
                    <span style="color: #ff0000; font-size: 18px; text-align: center;"> Username or Password are wrong</span>
                               <?php
                       }
                              if($_GET['message']=='error'){
                           ?>
                    <span style="color: #000; font-size: 18px; text-align: center;"> Account is not Confirmed.<a href="send_mail.php?username=<?php echo $_GET['username'];?>" style="text-decoration: underline;color: #ff0000;">Click here</a> to resend verification mail</span><br/> 
                               <?php
                       }
                    } ?>
                          <?php if(!empty($_GET['verify'])){
               if($_GET['verify']=='invalid'){
                           ?>
                    <span style="color: #ff0000; font-size: 18px; text-align: center;"> Something error occured please try again later</span><br/> 
                               <?php
                       }
                              if($_GET['verify']=='error'){
                           ?>
                    <span style="color: #000; font-size: 18px; text-align: center;">Activation Link is send to your mail</span>
                               <?php
                       }
                    } ?>
        </div>
	 <div class="form-group col-md-6">
					  ...
					  <br/>
					  <label for="checkuot-form-fname">Password<span class="mand-field">*</span></label>
                      <input id="checkuot-form-fname" type="Password" class="form-control" placeholder="Password" name="psw"  onpaste="return false;" required>
					  <br/>
					  <input type="submit" name="submit" class="btn btn-default" style="background-color: #0A4764;color: white;float:right;" value="Login" >
                                          <br/><br/><a href="register.php" style="float:right;text-decoration: underline;color: #000;font-size: medium;"> Don`t have a account? Click here</a>
                                          <br/><br/><a href="forgot-password.php" style="float:right;text-decoration: underline;color: #000;font-size: medium;"> Forgot Password ?</a>
                    </div>
