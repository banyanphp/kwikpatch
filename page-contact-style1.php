...
<!-- Mirrored from kodesolution.com/demo/personal/j/horseman/demo/page-contact-style1.php by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 10 Aug 2016 06:07:36 GMT -->
<head>
...
<div id="wrapper" class="clearfix">
      ...
      <div class="container pt-0 pb-0">
        <div class="row">
          <div class="col-xs-12 col-sm-3 col-md-6">
            <div class="widget no-border m-0">
              <a href="index-mp-layout1.php" class="menuzord-brand pull-left flip xs-pull-center mt-20 mb-10"><img alt="" src="images/logo-wide.png"></a>
            </div>
          </div>
          ...
          <nav id="menuzord" class="menuzord pull-left flip menuzord-responsive">
            <ul class="menuzord-menu">
              <li class="active"><a href="#home">Home</a>
                <ul class="dropdown">
                  <li><a href="#">Multi Page Layouts</a>
                    <ul class="dropdown">
                      <li><a href="index-mp-layout1.php">Layout1</a></li>
                      <li><a href="index-mp-layout2.php">Layout2</a></li>
                    </ul>
                  </li>
                  <li><a href="#">Single Page Layouts</a>
                    <ul class="dropdown">
                      <li><a href="index-sp-layout1.php">Layout1</a></li>
                      <li><a href="index-sp-layout2.php">Layout2</a></li>
                    </ul>
                  </li>
                  <li><a href="#">Boxed Layouts</a>
                    <ul class="dropdown">
                      <li><a href="index-boxed-mp-layout1.php">Boxed Multi Page Layout1</a></li>
                      <li><a href="index-boxed-mp-layout2.php">Boxed Multi Page Layout2</a></li>
                      <li><a href="index-boxed-sp-layout1.php">Boxed Single Page Layout1</a></li>
                      <li><a href="index-boxed-sp-layout2.php">Boxed Single Page Layout2</a></li>
                    </ul>
                  </li>
                  <li><a href="#">RTL Layouts</a>
                    <ul class="dropdown">
                      <li><a href="index-rtl-mp-layout1.php">RTL Multi Page Layout1</a></li>
                      <li><a href="index-rtl-mp-layout2.php">RTL Multi Page Layout2</a></li>
                      <li><a href="index-rtl-sp-layout1.php">RTL Single Page Layout1</a></li>
                      <li><a href="index-rtl-sp-layout2.php">RTL Single Page Layout2</a></li>
                    </ul>
                  </li>
                  <li><a href="#">Dark Layouts</a>
                    <ul class="dropdown">
                      <li><a href="index-dark-mp-layout1.php">Dark Multi Page Layout1</a></li>
                      <li><a href="index-dark-mp-layout2.php">Dark Multi Page Layout2</a></li>
                      <li><a href="index-dark-sp-layout1.php">Dark Single Page Layout1</a></li>
                      <li><a href="index-dark-sp-layout2.php">Dark Single Page Layout2</a></li>
                    </ul>
                  </li>
                </ul>
              </li>
              <li><a href="#">Pages</a>
                <ul class="dropdown">
                  <li><a href="#">About</a>
                    <ul class="dropdown">
                      <li><a href="page-about-style1.php">About Style 1</a></li>
                      <li><a href="page-about-style2.php">About Style 2</a></li>
                    </ul>
                  </li>
                  <li><a href="#">Gallery</a>
                    <ul class="dropdown">
                      <li><a href="page-image-gallery.php">Image Gallery</a>
                        <ul class="dropdown">
                          <li><a href="page-image-gallery-3col.php">3 Columns</a></li>
                          <li><a href="page-image-gallery-4col.php">4 Columns</a></li>
                        </ul>
                      </li>
                      <li><a href="page-video-gallery.php">Video Gallery</a>
                        <ul class="dropdown">
                          <li><a href="page-video-gallery-3col.php">3 Columns</a></li>
                          <li><a href="page-video-gallery-4col.php">4 Columns</a></li>
                        </ul>
                      </li>
                    </ul>
                  </li>
                  <li><a href="#">Courses</a>
                    <ul class="dropdown">                      
                      <li><a href="page-course-list-3col.php">Course 3 Columns</a></li>
                      <li><a href="page-course-list-4col.php">Course 4 Columns</a></li>
                      <li><a href="page-course-details.php">Course Details</a></li>
                    </ul>
                  </li>
                  <li><a href="page-facilities.php">Facilities</a></li>
                  <li><a href="page-events.php">Events</a></li>
                  <li><a href="#">Pricing</a>
                    <ul class="dropdown">
                      <li><a href="page-pricing-style1.php">Pricing style1</a></li>
                      <li><a href="page-pricing-style2.php">Pricing style2</a></li>
                    </ul>
                  </li>
                  <li><a href="#">Contact</a>
                    <ul class="dropdown">
                      <li><a href="page-contact-style1.php">Contact style 1</a></li>
                      <li><a href="page-contact-style2.php">Contact style 2</a></li>
                    </ul>
                  </li>
                  <li><a href="page-booking-form.php">Booking Form</a></li>
              ...
              <li><a href="page-membership.php">Membership</a></li>
              <li><a href="page-riding-school.php">Riding School</a></li>
              <li><a href="#home">Trainers</a>
                <ul class="dropdown">
                  <li><a href="page-trainers-style1.php">Trainers style 1</a></li>
                  <li><a href="page-trainers-style2.php">Trainers style 2</a></li>
                  <li><a href="page-trainer-details.php">Trainer Details</a></li>
                </ul>
              </li>
              <li><a href="#">Our Horses</a>
                <ul class="dropdown">
                  <li><a href="page-our-horses.php">Horse List</a></li>
                  <li><a href="page-horse-details.php">Horse Details</a></li>
                </ul>
              </li>
              <li><a href="#">Shop</a>
                <ul class="dropdown">
                  <li><a href="shop-category.php">Category</a></li>
                  <li><a href="shop-category-sidebar.php">Category Sidebar</a></li>
              ...
              <li><a href="#">Blog</a>
                <ul class="dropdown">
                  <li><a href="#">Blog Classic</a>
                    <ul class="dropdown">
                      <li><a href="blog-classic-no-sidebar.php">Blog Classic No Sidebar</a></li>
                      <li><a href="blog-classic-left-sidebar.php">Blog Classic Left Sidebar</a></li>
                      <li><a href="blog-classic-right-sidebar.php">Blog Classic Right Sidebar</a></li>
                      <li><a href="blog-classic-both-sidebar.php">Blog Classic Both Sidebar</a></li>
                    </ul>
                  </li>
                  <li><a href="#">Blog Grid</a>
                    <ul class="dropdown">
                      <li><a href="blog-grid-2-column.php">Blog Grid 2 Column</a></li>
                      <li><a href="blog-grid-3-column.php">Blog Grid 3 Column</a></li>
                      <li><a href="blog-grid-4-column.php">Blog Grid 4 Column</a></li>
                    </ul>
                  </li>
                  <li><a href="#">Blog Single</a>
                    <ul class="dropdown">
                      <li><a href="blog-single-no-sidebar.php">Blog Single No Sidebar</a></li>
            ...
            <ul class="pull-right flip hidden-sm hidden-xs">
              <li>
                ...
                <a class="btn btn-colored btn-flat top-left-triangle bg-theme-colored text-white font-14 bs-modal-ajax-load p-10 mt-15 pr-30 pl-15" data-toggle="modal" data-target="#BSParentModal" href="ajax-load/reservation-form.php">Get A quote Now</a>
          ...
          <div class="row"> 
            <div class="col-md-12">
              ...
              <ul class="list-inline text-white">
                <li>Home /</li>
                <li><span class="text-gray">Contact</span></li>
              </ul>
            </div>
          </div>
        </div>
      ...
      <div class="container pt-0 pb-60">
        ...
        <div class="row pt-10">
          ...
          <div class="col-md-7">
            ...
            <!-- Contact Form -->
            <form id="contact_form" name="contact_form" class="" action="http://kodesolution.com/demo/personal/j/horseman/demo/includes/sendmail.php" method="post">
  ...
  <!-- Footer -->
  <footer id="footer" class="divider layer-overlay overlay-dark-8" data-bg-img="images/bg/bg8.jpg">
        ...
        <div class="col-sm-6 col-md-3">
          <div class="widget dark">
            ...
            <ul class="list angle-double-right list-border">
              <li><a href="page-about-style1.php">About</a></li>
              <li><a href="page-membership.php">Membership</a></li>
              <li><a href="page-riding-school.php">Riding School</a></li>
              <li><a href="page-our-horses.php">Our Horses</a></li>
              <li><a href="shop-category-sidebar.php">Shop</a></li>              
            </ul>
          </div>
        </div>
        <div class="col-sm-6 col-md-3">
    ...
    <div class="footer-bottom bg-gray">
      <div class="container pt-15 pb-15">
        <div class="row">
          <div class="col-md-6">
            <p class="font-12 m-0">Copyright &copy;2015 ThemeMascot. All Rights Reserved</p>
          </div>
