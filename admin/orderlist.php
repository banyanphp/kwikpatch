...
">
        ...
        <div class="page-content container-fluid"> 
            <div class="widget-body"> 
              <table id="example-2" cellspacing="0" width="100%" class="table table-hover">
                    <thead>
                  <tr>
			...
			$q=mysqli_query($con, 'SELECT order_no,user_name,date,is_pending,is_shifted,is_processing,is_completed,id,SUM(qty) as total FROM tbl_order Group By order_no');
			     ...
			     ?> 
                    ...
                    <td class="text-center">
                      <div role="group" aria-label="Basic example" class="btn-group btn-group-sm">
                        ...
                        <button type="button"   class="btn btn-outline btn-success" onclick="window.location.href='change_order_status.php?id=<?php echo $row['id'];?>&page=4'"><i class="ti-pencil"></i></button>
