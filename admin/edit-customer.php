...
<!-- Mirrored from umega.lethemes.net/1.4.1/first-layout/edit-customer.php by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 25 May 2016 11:29:17 GMT -->
<head>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <title>Umega App - Edit Customer</title>
    <!-- PACE-->
    ...
    <div class="main-container">
        ...
        <ul class="list-unstyled navigation mb-0">
          ...
          <li class="panel"><a role="button" data-toggle="collapse" data-parent=".navigation" href="#collapse2" aria-expanded="true" aria-controls="collapse2" class="active"><i class="ti-shopping-cart"></i> E-commerce</a>
            <ul id="collapse2" class="list-unstyled collapse in">
              ...
              <li><a href="edit-customer.php" class="active">Edit customer</a></li>
            </ul>
          </li>
      ...
      <div class="page-container">
        <div class="page-header clearfix">
          <div class="pull-left">
            <h4 class="mt-0 mb-5">Edit Customer</h4>
        ...
        <div class="page-content container-fluid">
          <div class="widget">
            <div class="widget-heading clearfix">
              <h3 class="widget-title pull-left">Edit Customer</h3>
              <div class="pull-right">
            ...
            <div class="widget-body">
              <form class="form-horizontal">
                ...
                <div class="tab-content">
                  ...
                  <div id="orders" role="tabpanel" class="tab-pane">
