...
<!-- Mirrored from umega.lethemes.net/1.4.1/first-layout/profile.php by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 25 May 2016 11:30:19 GMT -->
<head>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <title>Umega App - Profile</title>
    <!-- PACE-->
  ...
  <body data-sidebar-color="sidebar-light" class="sidebar-light">
    ...
    <div class="main-container">
      ...
      <aside data-mcs-theme="minimal-dark" style="background-image: url(build/images/backgrounds/11.jpg)" class="main-sidebar mCustomScrollbar">
        ...
        <ul class="list-unstyled navigation mb-0">
          ...
          <li class="panel"><a role="button" data-toggle="collapse" data-parent=".navigation" href="#collapse17" aria-expanded="true" aria-controls="collapse17" class="active"><i class="ti-user"></i> User pages</a>
      ...
      <div class="page-container">
        ...
        <div class="page-content container-fluid p-0">
          <div class="row row-0">
            <div class="col-lg-12">
              <div style="height: 260px; padding-top: 130px; background-image: url(build/images/backgrounds/profile.png)" class="bg-overlay pl-30 pr-30 clearfix text-white">
                <div class="pull-left media">
                  <div class="media-left"><a href="javascript:void(0)" style="display: inline-block; border-radius: 50%; padding: 3px; background-color: #fff;"><img src="build/images/users/06.jpg" width="100" alt="" class="media-object img-circle"></a></div>
          ...
          <div class="row ml-10 mr-10 pt-10">
            ...
            <div class="col-md-6">
              <div class="widget clear">
                <div class="widget-heading">
                  <div class="media">
                    <div class="media-left"><img src="build/images/users/10.jpg" alt="" class="media-object mo-lg img-circle"></div>
                ...
                <div class="widget-body">
                  ...
                  <div class="thumbnail"><img src="build/images/backgrounds/02.jpg" alt="">
                  ...
                  <ul class="media-list">
                    <li class="media">
                      <div class="media-left avatar"><img alt="" src="build/images/users/01.jpg" class="media-object img-circle"><span class="status bg-success"></span></div>
                      <div class="media-body">
                        ...
                        <div class="media">
                          <div class="media-left avatar"><img alt="" src="build/images/users/12.jpg" class="media-object img-circle"><span class="status bg-success"></span></div>
                          <div class="media-body">
                            ...
                            <div class="media">
                              <div class="media-left avatar"><img alt="" src="build/images/users/11.jpg" class="media-object img-circle"><span class="status bg-success"></span></div>
                              <div class="media-body">
                        ...
                        <div class="media">
                          <div class="media-left avatar"><img alt="" src="build/images/users/14.jpg" class="media-object img-circle"><span class="status bg-success"></span></div>
                          <div class="media-body">
              ...
              <div class="widget clear">
                <div class="widget-heading">
                  <div class="media">
                    <div class="media-left"><img src="build/images/users/12.jpg" alt="" class="media-object mo-lg img-circle"></div>
                    <div class="media-body media-middle">
    ...
    <script type="text/javascript" src="build/js/page-content/user-pages/profile.js"></script>
  </body>

<!-- Mirrored from umega.lethemes.net/1.4.1/first-layout/profile.php by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 25 May 2016 11:30:20 GMT -->
</html>