        ...
        <div class="page-content container-fluid"> 
            <div class="widget-body"> 
              <table id="example-1" cellspacing="0" width="100%" class="table table-hover">
				...
				$q=mysqli_query($con, 'SELECT `order_no`,`user_name`,`date`,`is_pending`,`is_shifted`,`is_processing`,`is_completed`,`id`,SUM(qty) as total FROM tbl_order where is_pending=1 and is_shifted=1 and is_processing=0 and is_completed=0 group by order_no');
              ...
              <td class="text-center"><?php echo $row['order_no'] ?></td>
                    ...
                    <td><span class="label label-success" style="padding: 3px 15px;"> <?php  echo "Approved"; ?></span></td>
