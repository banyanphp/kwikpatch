...
<!-- Mirrored from umega.lethemes.net/1.4.1/first-layout/jquery-validation.php by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 25 May 2016 11:29:52 GMT -->
<head>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <title>Umega App - Validation</title>
    <!-- PACE-->
    ...
    <div class="main-container">
      ...
      <aside data-mcs-theme="minimal-dark" style="background-image: url(build/images/backgrounds/11.jpg)" class="main-sidebar mCustomScrollbar">
        ...
        <ul class="list-unstyled navigation mb-0">
          ...
          <li class="panel"><a role="button" data-toggle="collapse" data-parent=".navigation" href="#collapse8" aria-expanded="true" aria-controls="collapse8" class="active"><i class="ti-layers-alt"></i> Forms</a>
            <ul id="collapse8" class="list-unstyled collapse in">
              <li><a href="form-layouts.php">Layouts</a></li>
              <li><a href="jquery-validation.php" class="active">Validation</a></li>
      ...
      <div class="page-container">
        <div class="page-header clearfix">
          <div class="pull-left">
            <h4 class="mt-0 mb-5">Validation</h4>
              ...
              <form id="form-vertical" method="post" novalidate="novalidate">
                ...
                <div class="form-group">
                  ...
                  <div data-format="MM/DD/YYYY" class="input-group">
                    <input id="txtDatePicker" type="text" name="txtDatePicker" placeholder="Enter date" data-rule-required="true" data-rule-minlength="8" data-rule-date="true" class="form-control"><span class="input-group-addon"><i class="ti-calendar"></i></span>
                  </div>
                </div>
                <div class="form-group">
            ...
            <div class="widget-body">
              <form id="form-horizontal" method="post" novalidate="novalidate" class="form-horizontal">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input id="txtPasswordHor" type="password" name="txtPasswordHor" placeholder="Enter password" data-rule-required="true" data-rule-rangelength="[10,30]" class="form-control">
                  </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <div data-format="MM/DD/YYYY" class="input-group">
                      <input id="txtDatePickerHor" type="text" name="txtDatePickerHor" placeholder="Enter date" data-rule-required="true" data-rule-minlength="8" data-rule-date="true" class="form-control"><span class="input-group-addon"><i class="ti-calendar"></i></span>
                    </div>
                  </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input id="fulImageHor" type="file" name="fulImageHor" data-buttontext="Choose file" data-buttonname="btn-outline btn-primary" data-iconname="ti-image" data-rule-required="true" data-rule-accept="image/*" class="filestyle">
                  </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input id="txtPhoneUSHor" type="text" name="txtPhoneUSHor" placeholder="Enter phone US" data-rule-required="true" data-rule-phoneus="true" class="form-control">
                  </div>
                </div>
                <div class="form-group">
...
<!-- Mirrored from umega.lethemes.net/1.4.1/first-layout/jquery-validation.php by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 25 May 2016 11:29:53 GMT -->
</html>