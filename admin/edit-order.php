...
<!-- Mirrored from umega.lethemes.net/1.4.1/first-layout/edit-order.php by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 25 May 2016 11:29:17 GMT -->
<head>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <title>Umega App - Edit Order</title>
    <!-- PACE-->
    ...
    <div class="main-container">
        ...
        <ul class="list-unstyled navigation mb-0">
          ...
          <li class="panel"><a role="button" data-toggle="collapse" data-parent=".navigation" href="#collapse2" aria-expanded="true" aria-controls="collapse2" class="active"><i class="ti-shopping-cart"></i> E-commerce</a>
            <ul id="collapse2" class="list-unstyled collapse in">
              ...
              <li><a href="edit-order.php" class="active">Edit order</a></li>
      ...
      <div class="page-container">
        <div class="page-header clearfix">
          <div class="pull-left">
            <h4 class="mt-0 mb-5">Edit Order</h4>
            ...
            <div class="widget-body">
              <form class="form-horizontal">
                <ul role="tablist" class="nav nav-tabs mb-15">
                  ...
                  <li role="presentation"><a href="#totals" aria-controls="totals" role="tab" data-toggle="tab">Totals</a></li>
                </ul>
                <div class="tab-content">
                  <div id="customer" role="tabpanel" class="tab-pane active">
                    ...
                    <div class="form-group">
                      <label for="txtCustomerGroup" class="col-sm-3 control-label">Customer Group</label>
                      <div class="col-sm-9">
                        <input id="txtCustomerGroup" type="text" class="form-control">
                      </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      <label for="txtTelephone" class="col-sm-3 control-label">Telephone</label>
                      <div class="col-sm-9">
                        <input id="txtTelephone" type="text" class="form-control">
                      </div>
                    </div>
                    <div class="form-group">
                      <label for="txtFax" class="col-sm-3 control-label">Fax</label>
                      <div class="col-sm-9">
                    ...
                    <table style="width: 100%" class="table table-hover">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td class="text-center"><img src="build/images/products/02.jpg" width="50" alt="" class="img-thumbnail img-responsive"></td>
                        ...
                        <tr>
                          ...
                          <td class="text-center"><img src="build/images/products/03.jpg" width="50" alt="" class="img-thumbnail img-responsive"></td>
                  ...
                  <div id="payment" role="tabpanel" class="tab-pane">
                    <div class="form-group">
                      <label for="txtFax" class="col-sm-3 control-label">Method</label>
                      <div class="col-sm-9">
                        <div class="radio-inline radio-custom">
                          <input id="rdbCreditCard" type="radio" name="rdbPayment" value="1">
                          <label for="rdbCreditCard">Credit Card</label>
                        </div>
                        <div class="radio-inline radio-custom">
                    ...
                    <div class="form-group">
                      <label for="txtNameCard" class="col-sm-3 control-label">Name on Card</label>
                      <div class="col-sm-9">
                        <input id="txtNameCard" type="text" class="form-control">
                      </div>
                    </div>
                    <div class="form-group">
                      <label for="txtCardNumber" class="col-sm-3 control-label">Card Number</label>
                      <div class="col-sm-9">
                        <input id="txtCardNumber" type="text" class="form-control">
                      </div>
                    </div>
                    <div class="form-group">
                      <label for="ddlExpiryMonth" class="col-sm-3 control-label">Expiry Month</label>
                      <div class="col-sm-9">
                    ...
                    <div class="form-group">
                      <label for="ddlExpiryYear" class="col-sm-3 control-label">Expiry Year</label>
                      <div class="col-sm-9">
                    ...
                    <div class="form-group">
                      <label for="txtSecurityNumber" class="col-sm-3 control-label">Security Number</label>
                      <div class="col-sm-9">
                        <input id="txtSecurityNumber" type="text" class="form-control">
                      </div>
                    </div>
                  </div>
                  <div id="shipping" role="tabpanel" class="tab-pane">
                    <div class="form-group">
                      <label for="txtStreetAddress" class="col-sm-3 control-label">Street Address</label>
                      <div class="col-sm-9">
                        <input id="txtStreetAddress" type="text" class="form-control">
                      </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      <label for="txtZip" class="col-sm-3 control-label">Zip</label>
                      <div class="col-sm-9">
