...
<body class="">
  ...
  <!-- Footer -->
  <footer id="footer" class="divider layer-overlay overlay-dark-8" >
        ...
        <div class="col-sm-6 col-md-3">
          <div class="widget dark">
            ...
            <ul class="styled-icons icon-sm icon-bordered icon-theme-colored">
              <li><a href="https://www.facebook.com/kwik1987/"><i class="fa fa-facebook"></i></a></li>
...
<!-- Mirrored from kodesolution.com/demo/personal/j/horseman/demo/index-mp-layout2.php by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 10 Aug 2016 06:07:00 GMT -->
</html>